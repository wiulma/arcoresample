...
class ARCoreSessionLifecycleHelper(
  ...
  var TAG = "ARCoreSessionLifecycleHelper"
  ...
  private fun tryCreateSession(): Session? {
    ...
    if (!GeoPermissionsHelper.hasGeoPermissions(activity)) {
      ...
      Log.e(TAG, "tryCreateSession::CAMERA permission missing")
      return null
    }
    ...
    return try {
      ...
      Log.e("ARCORE", "arsample::Can't create session because of " +e.message)
  ...
  override fun onResume(owner: LifecycleOwner) {
    ...
    try {
      ...
      Log.e("ARCORE", "arsample::onResume CameraNotAvailableException " +e.message)
      exceptionCallback?.invoke(e)
    }
  }
